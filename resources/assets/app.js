(function () {
        ...
        function MediaSelector(root_path, label, name, move, max_file_count, type, sortable,modules) {
        ...
        MediaSelector.prototype.getMediaList = function () {
            ...
            $('#' + _this.input_name + 'MediaTable').bootstrapTable('destroy').bootstrapTable({
                url: '/admin/file-selector/file-list',         //请求后台的URL（*）
                method: 'post',                      //请求方式（*）
                ...
                columns: [
                    ...
                    {field: 'modules', title: '模块名', width: '80%'},
        ...
        MediaSelector.prototype.mediaUpload = function (data, whereToUpload) {
            ...
            $.each(files, function (i, field) {
                ...
                formData.append("modules", _this.modules);

                $.ajax({
                    type: 'post', // 提交方式 get/post
                    url: '/admin/file-selector/file-upload', // 需要提交的 url
                    data: formData,
                    processData: false,
                    contentType: false,
                    xhr: function () {
